            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="md:order-1">
                        <p className="text-lg mb-4">Welcome to Rev&apos;s American Grill, located in the Memorial Student Center (MSC) at Texas A&M University!</p>
                        ...
                        <p className="text-lg">Come visit us at the MSC and experience the taste of Rev&apos;s American Grill!</p>
                    </div>
                </div>
            </div>
        </div>
