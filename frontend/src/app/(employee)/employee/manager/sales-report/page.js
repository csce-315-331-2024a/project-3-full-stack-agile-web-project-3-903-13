...
export default function SalesReportPage() {
    ...
    const fetchSalesReport = async () => {
        ...
        setSuccessMessage('');
        try {
            const response = await fetch(`https://project-3-full-stack-agile-web-project-3-lc1v.onrender.com/api/transactions/salesreport?startDate=${startDate}&endDate=${endDate}`);
            if (!response.ok) {
