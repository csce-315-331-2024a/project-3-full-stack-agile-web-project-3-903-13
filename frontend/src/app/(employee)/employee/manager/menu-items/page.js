...
export default function ManagerPage() {
  ...
  const [addAllergy, setAddAllergy] = useState(0); // Separate state variable for Add Menu Item form
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="w-full  max-w-screen-xl mx-auto">
        <div className="flex justify-between mb-8">
          <div className="w-1/2 md:w-1/3 flex flex-col items-center border border-black-400 ">
              ...
              <div className="flex justify-between items-center mb-2 bg-white shadow-input outline-none border focus:border-red-800 rounded-lg px-2 py-2.5 ">
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    checked={addAllergy}
                    onChange={(e) => setAddAllergy(e.target.checked ? 0 : 1)}
                    className={`mb-1.5 px-4 justify-center items-center accent-red-800 form-checkbox h-4 w-5`}
                  />
                  <label className="ml-1 mb-2 justify-centere items-center">
                    Gluten Free
          ...
          <div className="w-full md:w-1/3 flex flex-col items-center border border-black-400">
